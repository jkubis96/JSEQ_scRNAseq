...
## UMAP presentation of the cell clusters

```{r echo=FALSE, message=FALSE, warning=FALSE, fig.align="center"}
knitr::include_graphics(file.path(path_results,'UMAP.jpeg'), dpi = 600)
```

### MAST algorithm - cluster markers
...
### MAST algorithm - subtype markers

```{r echo=FALSE, message=FALSE, warning=FALSE, align="center"}
markers <- read.csv(file = file.path(path_results, "MAST_subtypes.csv"), header = T, sep = ',', row.names = 1)
...
## Pheatmap of the cell subtypes with selected markers
### log(CPM+1)
...
### Cell subtypes heterogeneity - number of genes vs mean expression

```{r echo=FALSE, message=FALSE, warning=FALSE, fig.align= "center"}

knitr::include_graphics(file.path(path_results,'cells_heterogenity.jpeg'), dpi = 600)
