...
##### **For more information, please visit: https://github.com/jkubis96/JSEQ_scRNAseq/tree/v2.3.2**
...
##### **The number of genes and counts per cell**
...
##### **The ratio of the number of genes to counts**
...
##### **The percentage of ribosomal and mitochondrial genes [%]**
...
##### **Number of cells at different stages of the analysis**
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.align="center", dpi=300, retina=1}
...
##### **The cutoff for the number of principal components**
...
### **The results of cell grouping**
##### **UMAP processing and visualization of cell clusters**

```{r echo=FALSE, message=FALSE, warning=FALSE, fig.align="center"}
knitr::include_graphics(file.path(path_results,'UMAP.svg'), dpi = 600)
```

##### **Markers selected for the clusters**
...
### **Cluster classification and naming based on markers**
...
### **Presentation of subtypes identified with the CSSG algorithm**

\

##### **Quality control for cell subtypes**
...
### **Markers selected for the subtypes**
...
##### **Heatmap of cell subtypes with specific markers**
###### **Log(CPM + 1) normalization of expression**
...
### **Heterogeneity of cells within subtypes: number of genes vs. mean expression**
...
cat('The analysis was performed through the non-profit and open-source pipeline JSEQ_scRNAseq©. Pipeline belongs to the part of the JBioSystem© project in which we create complex software for bioinformatics analysis. Remember in silico analysis can not be taken for granted and must be validated in vitro or in vivo. For more information go to GitHub or contact us. The JSEQ_scRNAseq© was created in the Department of Molecular Neurobiology, Institute of Bioorganic Chemistry, Polish Academy of Sciences')
