...
show_image(file.path(results_dir, "PCA_DimPlot_subclasses.svg"), "## PCA cisualization of subclasses")
...
show_image(file.path(results_dir, "subclasses_composition.svg"), "## Subclasses - cell composition")
...
show_image(file.path(results_dir, "heatmap_cells_subclasses.svg"), "## Heatmap of cell subclasses - log(CPM + 1)")
...
show_image(file.path(results_dir, "heatmap_cells_subclasses_scaled.svg"), "## Heatmap of cell subclasses - scale(log(CPM + 1))")
...
show_image(file.path(results_dir, "subtypes_composition.svg"), "## Subtypes - cell composition")
...
show_image(file.path(results_dir, "heatmap_cells_subtypes.svg"), "## Heatmap of cell subtypes - log(CPM + 1)")
...
show_image(file.path(results_dir, "heatmap_cells_subtypes_scaled.svg"), "## Heatmap of cell subtypes - scale(log(CPM + 1))")
